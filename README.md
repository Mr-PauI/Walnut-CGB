...
Walnut-CGB. This is a full reimplementation of the core to support native 16-bit operations
and processing instructions with a dual-fetch chained architecture. A significant deviation
from the more portable 8-bit Walnut-CGB imlpementation.


This emulator is a work in based on Walnut-CGB and includes all DMG updates from its main branch
as well as the CGB support fork integrated into it.
